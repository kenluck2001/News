...
//SELECT a.uuid, a.year, a.day, a.hour, a.minute, a.second, a.month, a.title, a.source, a.doc_url, a.unix_timestamp, b.content FROM NewsMetaData a, NewsContent b WHERE b.content IS NOT NULL AND a.unix_timestamp>='1392022800' AND a.unix_timestamp<='1392757200'  AND a.uuid = b.uuid ORDER BY a.unix_timestamp;
// $extent_start = '1392022800';
// $extent_end = '1392757200' ;
$query = "SELECT DISTINCT a.uuid, a.year, a.day, a.hour, a.minute, a.second, a.month, a.title, a.source, a.doc_url, a.unix_timestamp, a.person, a.organization, a.topic, b.content, a.weekday FROM NewsMetaData a, NewsContent b WHERE a.topic LIKE '%".$term."%' AND  b.content IS NOT NULL AND trim(coalesce(b.content, '')) <>'' AND a.unix_timestamp>=".$extent_start." AND a.unix_timestamp<=".$extent_end ." AND a.uuid = b.uuid ORDER BY a.unix_timestamp " ;
...
if ($result_db->num_rows != 0)
{
	while ($text_row = $result_db->fetch_assoc())
	{
		...
		<div id = \"$relatedNewsDiv\"  >
			<a href='#' class=\"expander toggle\" data-id='$uuid' onclick='getRelatednewsID(this)' >Read related news </a> 
			<div class=\"clear\">
			<div class=\"content\">
			</div>	
...
//<a data-id=".$currentID." href='#'  onclick='getBreakingnewsID(this)'>  $title </a>
...
// <div id = \"$relatedNewsDiv\"  >
// <a href='#' class=\"expander toggle\"   >Read related news </a> <br/>
// <div class=\"content\">
// </div>
